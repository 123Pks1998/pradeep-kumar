    ...
    <>
      <motion.div initial={{ y: 10, opacity: 0 }}
        ...
        <div className="w-3/4  md:ml-10 ml-8">
          <div className="w-fit hover:scale-105 hover:duration-500">
            <div className="pl-4 py-2 text-white  ">
              ...
              <h1 className="font-serif md:w-96 mt-2">I am web developer with 1.5 year of experience in <u>Mern stack</u> & <u>Next js</u>. i have strong knowledge in front-end & back-end development with user-friendly and responsive web application.</h1>
            </div>
